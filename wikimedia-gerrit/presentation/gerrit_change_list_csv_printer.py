...
class GerritChangeListCsvPrinter:
    def print(self, changes):
        fieldnames = ['change_id', 'project', 'branch', 'status', 'subject', 'created_at', 'owner_id', 'submitted_at', 'submitter_id', 'phabricator_refs', 'revision_count', 'files_changed']
    ...
    def present_change_as_csv_fields(self, change):
        return {
            ...
            'submitter_id': str(change.submitter_id or ''),
