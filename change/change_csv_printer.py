...
class ChangeCsvPrinter:
    def __init__(self, output_handle):
        fieldnames = ['id', 'created_at', 'accepted_at', 'repository', 'vcs_system', 'author_organisation', 'author_team', 'lead_time_in_seconds', 'business_days_lead_time_in_seconds']
    ...
    def print(self, change, lead_time_in_seconds, business_days_lead_time_in_seconds):
        self.csv_writer.writerow(self.present_as_csv(change, lead_time_in_seconds, business_days_lead_time_in_seconds))

    def present_as_csv(self, change, lead_time_in_seconds, business_days_lead_time_in_seconds):
        return {
            'id': str(change.id or ''),
